...
export default function NewsletterPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold tracking-tight text-foreground">Newsletter</h2>
        <p className="mt-1 text-sm text-foreground-2">Distribute your content via Newsletter.</p>
      </div>
      ...
      <SocialPanel platform="newsletter" />
    </div>
  );
}
