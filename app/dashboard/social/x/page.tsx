...
export default function XPage() {
  const [activeChannel, setActiveChannel] = useState("X / Twitter");

  return (
    <div className="space-y-6">
      <div>
        <h2 className="text-2xl font-bold tracking-tight text-foreground">X (Twitter)</h2>
        <p className="mt-1 text-sm text-foreground-2">Distribute your content to X / Twitter.</p>
      </div>
